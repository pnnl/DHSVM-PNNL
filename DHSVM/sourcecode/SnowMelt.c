 ...
 * FUNCTIONS:    SnowMelt()
 * COMMENTS:
 * $Id: SnowMelt.c,v 1.2 2002/10/02 00:36:04 nijssen Exp $     
 */
               ...
               OPTIONSTRUCT * Options, float *IceRemoved)
{
 ...
 //Snow Density Variables
  ...
  float depth_new;
  float meltin;
  float excess;      /* amount meltwater exceeding water storage capacity of glacier (m)*/
  float k;           /* reservoir release paramerer (hrs)*/
  float Qout;       /*Melt water released at bottom of glacier*/
